...
const projects = [
  ...
  },
  {
    ...
    tools: ['React', 'Node.js', 'OpenAI', 'Supabase', 'Redis', 'Google Calendar API'],
    industry: 'EdTech',
    url: 'https://github.com/AnkitRegmi1/TruCompass',
    image: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=1080',
    excerpt: 'AI voice assistant for Truman State University that unifies campus events, dining, scheduling, and planning into one personalized experience.',
    previewType: 'image',
  },
  {
    name: 'AI Voice',
    timeframe: '2026',
    discipline: 'Dev / AI',
    tools: ['Python', 'AI', 'Speech Recognition', 'TTS', 'Twilio'],
    industry: 'AI',
    url: 'https://github.com/AnkitRegmi1/AIVoice',
    image: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=1080',
    excerpt: 'Automates calls and appointment scheduling for small businesses using an AI voice agent.',
    previewType: 'image',
  },
  {
    name: 'TecBlog AI',
